CKEDITOR.editorConfig = (config) => {
    ...
    // set-ckeditor.js 에서 등록해야 제대로 동작함.
    // config.extraPlugins = 'tableresize';
    config.extraPlugins = 'uploadimage';
    config.removePlugins = 'exportpdf,wsc,smiley,iframe,flash,scayt';

    config.imageUploadUrl = '/attachments/images?type=Images';
    config.filebrowserImageUploadUrl = '/attachments/images?type=Images';
    ...
    config.toolbar = [
        { name: 'document', groups: [ 'mode', 'document', 'doctools' ], items: [ 'NewPage', 'Print' ] },
