...
public class CompanyScheduleController {
    ...
    @Autowired
    public CompanyScheduleController(PersonalScheduleService service) {
    ...
    @PostMapping("/all-day")
    public ResponseEntity<Object> save(@Validated @RequestBody DtorSchedule dto, BindingResult result, @AuthenticationPrincipal LoginUser loginUser) {
        if(result.hasErrors())
            return ResponseConverter.badRequest(result);
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Object> update(@PathVariable Long id, @Validated DtorScheduleIncludedTime dto, BindingResult result, @AuthenticationPrincipal LoginUser loginUser) {
        if(result.hasErrors())
            return ResponseConverter.badRequest(result);
    ...
    @PatchMapping("/{id}/all-day")
    public ResponseEntity<Object> update(@PathVariable Long id, @Validated DtorSchedule dto, BindingResult result, @AuthenticationPrincipal LoginUser loginUser) {
        if(result.hasErrors())
            return ResponseConverter.badRequest(result);
